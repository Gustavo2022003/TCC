...
export default function Profile({navigation}) {
    ...
    async function GetProfile(){
            ...
            let response= await fetch('http://192.168.43.53:3000/getAvatar/'+user.id,{
                method: 'POST',
                headers: {
            ...
            if (Image === null){
                setPicture('http://192.168.43.53:3000/Images/17bcb88b-4881-4d42-bf97-2b8793c16a65.png')
            }else{
            ...
            let picturePath = 'http://192.168.43.53:3000/Images/'
    ...
    async function GetReceita(){
        let getuser = await AsyncStorage.getItem('userData');
        let user = JSON.parse(getuser);
        let response = await fetch('http://192.168.43.53:3000/recipe/'+user.id,{
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
    ...
    const openImagePickerAsync = async () => {
        ...
        if (!pickerResult.cancelled) {
            ...
            await axios.post('http://192.168.43.53:3000/uploadPicture/'+user, formData, {headers: {
